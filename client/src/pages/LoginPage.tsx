    ...
    return (
        <Container className="d-flex align-items-center justify-content-center" style={{paddingTop: "15vh"}}>
            <div className="w-100" style={{maxWidth: "400px"}}>
                ...
                <Form onSubmit={(e) => {
                    ...
                    <div style={{display: "flex", justifyContent: "space-between", width: "100%"}}>
                        <Button variant="primary" type="submit" style={{background: "black", borderColor: "black", paddingLeft:"23.5px", paddingRight:"23.5px", textAlign:"center"}}>
                            Войти
                        </Button>
                        <Button style={{ marginLeft: "10px" }}  id="VKIDSDKAuthButton" className="VkIdWebSdk__button VkIdWebSdk__button_reset" onClick={handleClick}>
           ...
           17.5682 18.8875 19.31H21.4939C20.7869 16.7044 18.9535 15.2604 17.8141 14.71C18.9526 14.0293 20.5641 12.3893 20.9436 10.15H18.5722C18.0747 11.971 16.5945 13.6233 15.1803 13.78V10.15H12.7711V16.5C11.305 16.1337 9.39237 14.3538 9.314 10.15H6.79999Z"
                        ...
                        <Button variant="primary" style={{marginLeft: "10px",background: "black", borderColor: "black"}}
