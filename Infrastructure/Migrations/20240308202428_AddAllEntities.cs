        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CreationDateTimeUtc = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    ExpirationDateTimeUtc = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProductImages", x => new { x.ImagesId, x.ProductsId });
                    table.ForeignKey(
                        name: "FK_ProductImages_MediaFiles_ImagesId",
                        column: x => x.ImagesId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_StoryMediaFiles", x => x.Id);
                    table.ForeignKey(
                        name: "FK_StoryMediaFiles_MediaFiles_MediaFileId",
                        column: x => x.MediaFileId,
                        principalTable: "MediaFiles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_StoryMediaFiles_Stories_StoryId",
                        column: x => x.StoryId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StoryMediaFiles_MediaFileId",
                table: "StoryMediaFiles",
                column: "MediaFileId");

            migrationBuilder.CreateIndex(
                name: "IX_StoryMediaFiles_StoryId",
                table: "StoryMediaFiles",
                column: "StoryId");
